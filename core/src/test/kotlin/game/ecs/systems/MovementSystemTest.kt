...
class MovementSystemTest {
    ...
    private val ms = MovementSystem(cellSize = 10f, offsetX = 0f, offsetY = 0f, playWidth = 100f, playHeight = 100f)

    private fun emptyCells(cols: Int = 10, rows: Int = 10): Array<Array<CellType>> =
        Array(cols) { Array(rows) { CellType.FREE } }

    private fun borderedCells(cols: Int = 10, rows: Int = 10): Array<Array<CellType>> {
        val g = emptyCells(cols, rows)
